...
export const options = {
    scenarios: {
        create_and_summarize_document_scenario: {
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'createAndSummarizeDocumentScenario'
        },
        create_and_elaborate_document_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'createAndElaborateDocument'
        },
        create_and_summarize_and_fact_check_document_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'createSummarizeAndFactCheckDocument'
        },
        chat_question_and_answer_with_rag_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'chatQuestionAndAnswerWithRAG'
        },
        chat_question_and_answer_with_notes_rag_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'chatQuestionAndAnswerWithNotesRAG'
        },
        chat_with_llm_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
        ...
        chat_with_llm_and_upload_picture_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'chatWithLLMAndUploadPicture'
        },
        chat_with_llm_and_upload_pdf_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'chatWithLLMAndUploadPDF'
        },
        chat_with_llm_and_upload_video_scenario: {
            executor: 'constant-arrival-rate',
            duration: '600s',
            preAllocatedVUs: 1,
            ...
            rate: 1,
            timeUnit: '180s',
            exec: 'chatWithLLMAndUploadVideo'
        }
    }
};
...
export function createAndSummarizeDocumentScenario(data) {
...
export function createAndElaborateDocument(data) {
...
export function createSummarizeAndFactCheckDocument(data) {
...
export function chatQuestionAndAnswerWithRAG(data) {
...
export function chatQuestionAndAnswerWithNotesRAG(data) {
...
export function chatWithLLM(data) {
    group('Chat with LLM', () => {
...
export function chatWithLLMAndUploadPicture(data) {
...
export function chatWithLLMAndUploadPDF(data) {
...
export function chatWithLLMAndUploadVideo(data) {
